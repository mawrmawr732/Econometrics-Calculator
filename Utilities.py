...
PATH = r"C:\Users\test\Desktop\IR excel spreadsheets\Utilities.xlsx"


class Utilities():
    def __init__(self):
        utilitiesData = pandas.read_excel(r"C:\Users\test\Desktop\IR excel spreadsheets\Utilities.xlsx")
        self.utilitiesDate = utilitiesData.Date
        self.modelDate = self.utilitiesDate.drop(self.utilitiesDate.index[0])
        self.utilitiesReturn = utilitiesData.Level
        self.utilitiesARCHReturn = 100 * self.utilitiesReturn.pct_change().dropna()
        self.xposition = ['3JANUARY2013', '3JANUARY2015', '3JANUARY2017']
        pandas.to_datetime(self.xposition)

    def timeseries(self):
        fig1 = plt.figure()
        utilitiesGraph = fig1.add_subplot(111)
        utilitiesGraph.plot(self.utilitiesDate, self.utilitiesReturn)
        utilitiesGraph.set_title('Time Series')
    ...
    def archmodel(self):
        self.am = arch.arch_model(self.utilitiesARCHReturn)
