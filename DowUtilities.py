...
class DowUtilities():
    def __init__(self):
        ...
        self.dowUtilityReturn = dowData.Utility
        self.dowUtilityARCHReturn = 100 * self.dowUtilityReturn.pct_change().dropna()
    ...
    def timeseries(self):
        fig1 = plt.figure()
        dowUtilityGraph = fig1.add_subplot(111)
        dowUtilityGraph.plot(self.dowDate, self.dowUtilityReturn)
        dowUtilityGraph.set_title('Time Series')
        fig1.autofmt_xdate()
        fig1.draw
    ...
    def archmodel(self):
        self.am = arch.arch_model(self.dowUtilityARCHReturn)
