...
PATH = r"C:\Users\test\Desktop\IR excel spreadsheets\Technology.xlsx"


class Technology():
    def __init__(self):
        technologyData = pandas.read_excel(r"C:\Users\test\Desktop\IR excel spreadsheets\Technology.xlsx")
        self.technologyDate = technologyData.Date
        self.modelDate = self.technologyDate.drop(self.technologyDate.index[0])
        self.technologyReturn = technologyData.Level
        self.technologyARCHReturn = 100 * self.technologyReturn.pct_change().dropna()
        self.xposition = ['3JANUARY2013', '3JANUARY2015', '3JANUARY2017']
        pandas.to_datetime(self.xposition)

    def timeseries(self):
        fig1 = plt.figure()
        technologyGraph = fig1.add_subplot(111)
        technologyGraph.plot(self.technologyDate, self.technologyReturn)
        technologyGraph.set_title('Time Series')
    ...
    def archmodel(self):
        self.am = arch.arch_model(self.technologyARCHReturn)
