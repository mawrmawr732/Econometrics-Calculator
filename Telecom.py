...
PATH = r"C:\Users\test\Desktop\IR excel spreadsheets\Telecom.xlsx"


class Telecom():
    def __init__(self):
        telecomData = pandas.read_excel(r"C:\Users\test\Desktop\IR excel spreadsheets\Telecom.xlsx")
        self.telecomDate = telecomData.Date
        self.modelDate = self.telecomDate.drop(self.telecomDate.index[0])
        self.telecomReturn = telecomData.Level
        self.telecomARCHReturn = 100 * self.telecomReturn.pct_change().dropna()
        self.xposition = ['3JANUARY2013', '3JANUARY2015', '3JANUARY2017']
        pandas.to_datetime(self.xposition)

    def timeseries(self):
        fig1 = plt.figure()
        telecomGraph = fig1.add_subplot(111)
        telecomGraph.plot(self.telecomDate, self.telecomReturn)
        telecomGraph.set_title('Time Series')
    ...
    def archmodel(self):
        self.am = arch.arch_model(self.telecomARCHReturn)
