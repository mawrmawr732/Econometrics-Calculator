...
PATH = r"C:\Users\test\Desktop\IR excel spreadsheets\Mid Cap.xlsx"


class MidCap():
    def __init__(self):
        midCapData = pandas.read_excel(r"C:\Users\test\Desktop\IR excel spreadsheets\Mid Cap.xlsx")
        self.midCapDate = midCapData.Date
        self.modelDate = self.midCapDate.drop(self.midCapDate.index[0])
        self.midCapReturn = midCapData.Level
        self.midCapARCHReturn = 100 * self.midCapReturn.pct_change().dropna()
        self.xposition = ['3JANUARY2013', '3JANUARY2015', '3JANUARY2017']
        pandas.to_datetime(self.xposition)

    def timeseries(self):
        fig1 = plt.figure()
        midCapGraph = fig1.add_subplot(111)
        midCapGraph.plot(self.midCapDate, self.midCapReturn)
        midCapGraph.set_title('Time Series')
    ...
    def archmodel(self):
        self.am = arch.arch_model(self.midCapARCHReturn)
